...
@include "controlers/tambahJbarang.php";
session_start();
...
<body>
                            ...
                            <form action="" method="post">
                                <div class="row g-3">
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="text" name="jenis_barang" class="form-control" aria-label="jenis_barang" required autocomplete="off">
                                    </div>
                                </div>
                                <button type="submit" name="tambahJbarang" class="btn btn-primary mt-3">
                                    Tambah
                                </button>
                            </form>
                        </div>
    ...
    if (isset($_POST["tambahJbarang"])) {
        if (tambahJbarang($_POST) > 0) {
            echo "<script>
            swal({
                title: 'Berhasil',
            ...
            setTimeout(function(){
                window.location = 'jenisBarang.php';
            }, 2000);
            </script>";
        } else {
            echo "<script>
