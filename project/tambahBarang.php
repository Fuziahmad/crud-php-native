...
@include "controlers/tambahBarang.php";
session_start();
...
<body>
    <nav class="sb-topnav fixed-top navbar navbar-expand navbar-dark bg-dark ">
        <!-- Navbar Brand-->
        <a class="navbar-brand mx-3" href="index.php"><b class="brand">Kelompok 1</b></a>
        <!-- Sidebar Toggle-->
        <button class="btn btn-dark" id="button-toggle">
            <i class="fas fa-bars"></i>
        </button>
        <marquee class="marquee text-light" behavior="scroll" direction="left" loop="infinite">🚀 Kami Dari Kelompok 1 🚀<span style="margin-left: 960px;">Project Ini Diajukan Untuk Memenuhi Tugas Praktikum Pemrograman Web 1 </span></marquee>
    </nav>
                            ...
                            <form action="" method="post">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="text" name="model" class="form-control" aria-label="model" required autocomplete="off">
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                        <label for="harga" class="form-label">Harga</label>
                                        <input type="text" name="harga" class="form-control f-num" aria-label="harga" required autocomplete="off">
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <label for="ukuran" class="form-label">Ukuran</label>
                                        <input type="text" name="ukuran" class="form-control" aria-label="ukuran" autocomplete="off">
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <label for="stok" class="form-label">Stok</label>
                                        <input type="text" name="stok" class="form-control f-num" aria-label="stok">
                                    </div>

                                </div>
                                <button type="submit" name="tambahBarang" class="btn btn-primary mt-3">
                                    Tambah
                                </button>
                            </form>
                        </div>
